...
def DACs_to_temp(DAC1,DAC2,R_fixed):
	...
	# DAC1 measures the voltage across the thermistor + fix resistor
	...
	# 100k thermistor
	# https://www.digikey.com/en/products/detail/murata-electronics/NXFT15WF104FA2B100/2533824
	# B25/50	4250K
	# B25/85	4311K
	# B25/100	4334K

	B = 4250
	R_thermistor = R_fixed*fraction/(1-fraction)
	...
	inverseT_K = (1/(25+273.15)) + (1/B)*np.log(R_thermistor/100000)
	T_K = 1/inverseT_K
	T_degreeC = T_K - 273.15
